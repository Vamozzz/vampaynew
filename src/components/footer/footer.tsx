...
import { gotoFacebook, gotoInstagram, gotoLinkedin, gotoMedium, gotoTwitter, gotoWhatsapp } from "@/utils/customFunctions";
  ...
  return (
    ...
    >
        ...
        <div className=" flex lg:flex-1 flex-col gap-5 lg:flex-row justify-around">
          <div className=" flex flex-row gap-10">
            <div className="flex flex-col">
              ...
              <Link href="/products/collection" className="text-md md:block text-[#565758] hover:text-primaryPurple-100 ">
                Collection
              </Link>
              <Link href="/products/payouts" className="text-md md:block text-[#565758]  hover:text-primaryPurple-100 ">
              Payout
              </Link>
            </div>
            <div className="flex flex-col">
              ...
              <Link href="/developerapi" className="text-md md:block text-[#565758]  hover:text-primaryPurple-100 ">
              API Information
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col"> 
              ...
              <Link href="/company/aboutus" className="text-md md:block text-[#565758]  hover:text-primaryPurple-100 ">
              About us
              </Link>
              <Link href="/company/contactus" className="text-md md:block text-[#565758]  hover:text-primaryPurple-100 ">
              Contact us
              </Link>
              <Link href="/company/blogs" className="text-md md:block text-[#565758]  hover:text-primaryPurple-100 ">
              Career
              </Link>
              <Link href="/company/faqs" className="text-md md:block text-[#565758]  hover:text-primaryPurple-100 ">
              FAQ
              </Link>
      ...
      <div className="bg-primaryPurple flex justify-center items-center p-6 ">
        <p className="font-normal text-[10px] lg:text-[16px]  text-[#fff]" >© 2022 Vaamoz Online Private Limited. All rights reserved.</p>
      </div>
    </div>
  );
}
