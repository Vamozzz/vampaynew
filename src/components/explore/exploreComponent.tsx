...
const ExploreComponent = () => {
  ...
  return (
    <section  className="p-10 lg:p-20">
      <div  style={gradientStyle}  className="flex flex-col p-8 rounded-xl gap-4 lg:flex-row justify-center items-center">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-row justify-center lg:justify-start gap-4 items-center py-6">
            <CustomButton filled={true}>Get Started</CustomButton>
            <TextButton endIcon={true} >Get Started</TextButton>
          </div>
        </div>
      </div>
    </section>
